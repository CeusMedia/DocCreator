 ...
 *
 *	@category		cmTools
 *	@package		DocCreator_Model
 *	@author			Christian Würker <christian.wuerker@ceus-media.de>
 *	@copyright		2008-2009 Christian Würker
 *	@license		http://www.gnu.org/licenses/gpl-3.0.txt GPL 3
 *	@version		$Id: Interface.php5 725 2009-10-20 05:41:39Z christian.wuerker $
 *	@since			0.3
 */
/**
 *	Interface Data Class.
...
class Model_Interface
{
	...
	/**
	 *	Constructor, binding a Model_File.
	 *	@access		public
	 *	@param		Model_File	$file		File with contains this interface
	 *	@return		void
	 */
	 ...
	 *	@return		Model_Method		Method data object
	 ...
	 *	@access		public
	 *	@return		Model_File		Parent File Data Object
	...
	public function merge( Model_Interface $interface )
	{
	 ...
	 *	Sets author.
	 *	@access		public
	 *	@param		Model_Author	$author		Author data object
	 *	@return		void
	 */
	...
	public function setComposingClass( Model_Class $class )
	{
	...
	public function setExtendingInterface( Model_Interface $interface )
	{
	...
	public function setImplementingClass( Model_Class $class )
	{
		$this->implementedBy[$class->getName()]	= $class;
	}

	public function setLicense( Model_License $license )
	{
	 ...
	 *	Sets a method.
	 *	@access		public
	 *	@param		Model_Method	$method		Method to add to interface
	 *	@return		void
	 */
	public function setMethod( $name, Model_Method $method )
	{
	 ...
	 *	@return		void
	 */
	public function setParent( Model_File $parent )
	{
		$this->parent	= $parent;
	}

	public function setReceivingClass( Model_Class $class )
	{
		return $this->receivedBy[$class->getName()]	= $class;
	}

	public function setReturningClass( Model_Class $class )
	{
	...
	public function setUsingClass( Model_Class $class )
	{
