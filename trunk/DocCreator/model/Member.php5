 ...
 *	@version		$Id: Member.php5 725 2009-10-20 05:41:39Z christian.wuerker $
 *	@since			0.3
 */
/**
 *	Class Member Data Class.
 ...
 *	@since			0.3
 */
class Model_Member extends Model_Variable
{
	 ...
	 *	@access		public
	 *	@return		Model_Interface	Parent Class or Interface Data Object
	 */
	...
	public function merge( Model_Member $member )
	{
		parent::merge( $member );
#		remark( 'merging member: '.$member->getName() );
	 ...
	 *	@access		public
	 *	@param		Model_Interface	$parent			Parent Class or Interface Data Object
	 *	@return		void
	 */
	public function setParent( Model_Interface $parent )
	{
		$this->parent	= $parent;
	}
