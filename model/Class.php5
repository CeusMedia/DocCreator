 ...
 *	@since			0.3
 */
class Model_Class extends Model_Interface
{
	 ...
	 *	@return		Model_Member	Member data object
	 */
	...
	public function merge( Model_Class $class )
	{
	...
	public function isImplementingInterface( Model_Interface $interface  )
	{
	...
	public function isUsingClass( Model_Class $class )
	{
	...
	public function setExtendedClass( Model_Class $class )
	{
		$this->extends	= $class;	
	}
	...
	public function setExtendingClass( Model_Class $class )
	{
	...
	public function setImplementedInterface( Model_Interface $interface )
	{
	 ...
	 *	@param		Model_Member	Member data object to set
	 *	@return		void
	 */
	public function setMember( $name, Model_Member $member )
	{
		$this->members[$name]	= $member;
	}
	
	public function setUsedClass( Model_Class $class )
	{
